...
const expiredCheck = (sender, _dir) => {
    setInterval(() => {
        let position = null
        Object.keys(_dir).forEach((i) => {
        ...
        if (position !== null) {
            ...
            sender.sendMessage(_dir[position].id, `*| PREMIUM EXPIRED |*\n\nWaktu premium anda sudah habis, jika ingin memperpanjang silahkan hubungi owner bot`, MessageType.text)
